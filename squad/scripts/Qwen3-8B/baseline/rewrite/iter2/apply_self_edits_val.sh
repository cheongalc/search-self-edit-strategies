...
SELF_EDIT_DATA_PATH=$REPO_ROOT/squad/data/Qwen3-8B/baseline/rewrite/iter2/val_thinking.json
SCRATCH_DIR=/compute/babel-p5-24/acheong/idl
...
LOG_LEVEL="DEBUG"
EXP_NAME="apply_self_edits_Qwen3-8B_baseline_rewrite_iter2_val"
