...
SELF_EDIT_DATA_PATH=$REPO_ROOT/squad/data/Qwen3-8B/baseline/rewrite/iter4/val_thinking.json
SCRATCH_DIR=/compute/babel-o5-24/acheong/idl
OUTPUT_DIR=$REPO_ROOT/squad/results
MODEL_NAME=$REPO_ROOT/squad/models/Qwen3-8B/baseline/rewrite/iter3
NUM_GPUS=4
...
LOG_LEVEL="DEBUG"
EXP_NAME="apply_self_edits_Qwen3-8B_baseline_rewrite_iter4_val"
