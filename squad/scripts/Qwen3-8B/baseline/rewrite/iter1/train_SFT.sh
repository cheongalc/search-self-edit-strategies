...
SFT_DATASET_PATH=$REPO_ROOT/squad/data/Qwen3-8B/baseline/rewrite/iter2/sft_dataset_2025-12-02T17:08:28.323501_top2.jsonl
MODEL_NAME=$REPO_ROOT/squad/models/Qwen3-8B/baseline/rewrite/iter0
CHECKPOINT_OUTPUT_DIR=$REPO_ROOT/squad/models/Qwen3-8B/baseline/rewrite/iter1
