...
MODEL=$REPO_ROOT/squad/models/Qwen3-8B/baseline/rewrite/iter2  # model to use for data generation. For evaluation, set to the model to be evaluated. For RL training, set to the (n-1)'th RL checkpoint.
...
DATASET_OUT="$REPO_ROOT/squad/data/Qwen3-8B/baseline/rewrite/iter3/train_thinking.json"
...
VLLM_LOG_PATH="$REPO_ROOT/squad/logs/Qwen3-8B/vllm_create_self_edits_baseline_rewrite_iter3_train.log"
