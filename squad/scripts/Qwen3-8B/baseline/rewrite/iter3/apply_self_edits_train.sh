...
SELF_EDIT_DATA_PATH=$REPO_ROOT/squad/data/Qwen3-8B/baseline/rewrite/iter3/train_thinking.json
SCRATCH_DIR=/scratch
...
LOG_LEVEL="DEBUG"
EXP_NAME="apply_self_edits_Qwen3-8B_baseline_rewrite_iter3_train"
