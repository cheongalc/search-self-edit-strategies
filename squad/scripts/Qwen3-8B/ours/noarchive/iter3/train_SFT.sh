...
SFT_DATASET_PATH=$REPO_ROOT/squad/data/Qwen3-8B/ours/iter4/sft_dataset_2025-11-30T07:36:26.196733_top2.jsonl
MODEL_NAME=$REPO_ROOT/squad/models/Qwen3-8B/ours/iter2
CHECKPOINT_OUTPUT_DIR=$REPO_ROOT/squad/models/Qwen3-8B/ours/iter3
