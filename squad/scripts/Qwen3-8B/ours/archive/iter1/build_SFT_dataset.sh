...
SELF_EDIT_RESULTS_JSON_PATH=$REPO_ROOT/squad/results/Qwen3-8B/ours/archive/iter1_train/results.json
DATASET_OUTPUT_DIR=$REPO_ROOT/squad/data/Qwen3-8B/ours/archive/iter2
