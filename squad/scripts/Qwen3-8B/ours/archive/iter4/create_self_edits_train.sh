...
MODEL=$REPO_ROOT/squad/models/Qwen3-8B/ours/archive/iter3 # model to use for data generation. For evaluation, set to the model to be evaluated. For RL training, set to the (n-1)'th RL checkpoint.
...
DATASET_OUT="$REPO_ROOT/squad/data/Qwen3-8B/ours/archive/iter4/train_thinking.json"

ARCHIVE_PATH=$REPO_ROOT/squad/results/Qwen3-8B/ours/archive/iter3_train/archive.json
...
VLLM_LOG_PATH="$REPO_ROOT/squad/logs/Qwen3-8B/vllm_create_self_edits_archive_iter4_train.log"
