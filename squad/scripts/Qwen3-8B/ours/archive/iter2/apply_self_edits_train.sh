...
SELF_EDIT_DATA_PATH=$REPO_ROOT/squad/data/Qwen3-8B/ours/archive/iter2/train_thinking.json
SCRATCH_DIR=/scratch
OUTPUT_DIR=$REPO_ROOT/squad/results
MODEL_NAME=$REPO_ROOT/squad/models/Qwen3-8B/ours/archive/iter1
NUM_GPUS=8
...
LOG_LEVEL="DEBUG"
EXP_NAME="apply_self_edits_Qwen3-8B_iter2_train_archive"
